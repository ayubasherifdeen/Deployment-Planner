...
export default function AssignedMissionsTab({
  missions,
  personnel,
}: AssignedMissionsTabProps) {
              ...
              <div className="mb-3">
                ...
                <div className="h-1.5 w-full overflow-hidden rounded-full bg-gray-200">
                  <div
                    ...
                    style={{
                      width: `${Math.round((mission.assignedPersonnel.length / mission.teamSize) * 100)}%`,
                    }}
                  />
                </div>
              </div>
              ...
              {mission.assignedPersonnel.length > 0 && (
                <div className="mb-3">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {mission.assignedPersonnel.map((pid) => {
